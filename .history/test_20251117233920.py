...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            r"C:\Users\prajyot\Documents\LLMOps\data\ml.txt",
        ]
        ...
        # - lambda_mult: Diversity parameter (0=max diversity, 1=max relevance, 0.5=balanced)retriever = ci.build_retriever(
    uploaded_files, 
    chunk_size=200, 
    chunk_overlap=20, 
    k=5,
