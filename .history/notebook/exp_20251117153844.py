...
from langchain_community.embeddings import GooglePalmEmbeddingsfrom langchain_google_vertexai import VertexAIEmbeddings langchain_community.vectorstores import FAISS
