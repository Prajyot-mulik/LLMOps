...
class ChatIngestor:
    def __init__(
        ...
        try:
            self.model_loader = ModelLoader()  # ✅ OpenRouter‑only loader
    ...
    def _split(self, docs: List[Document], chunk_size=1000, chunk_overlap=200) -> List[Document]:
        ...
        "Documents split. chunks={len(chunks)}, chunk_size={chunk_size}, overlap={chunk_overlap}")
        return chunkslog.info(f
...
class FaissManager:
    def __init__(self, index_dir: Path, model_loader: Optional[ModelLoader] = None):
        ...
        self.emb = self.model_loader.load_embeddings()  # ✅ OpenRouter embeddings
